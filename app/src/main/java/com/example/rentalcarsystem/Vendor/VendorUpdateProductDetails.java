...
public class VendorUpdateProductDetails extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onStart() {
        ...
        if(mAuth.getCurrentUser()!=null) {
            ...
            startActivity(new Intent(VendorUpdateProductDetails.this, MainActivity.class));
            finish();
        }
    }
    @Override
...
//        Main update process will happen here
        setContentView(R.layout.activity_vendor_update_product_details);
        //init sippner
        ...
        //set
        addProduct_address.setText(products.getpAddress());
        addProduct_availble.setText(products.getpAvailable());
        addProduct_pName.setText(products.getpName());
        addProduct_Price.setText(products.getPricePerDay());
//        bookId.setText(book.getbId());
        Picasso.get().load(products.getpImageUrl()).into(selected_img);
    ...
    void checkValidation(){
        ...
        if(Name.isEmpty()){
            ...
            startUpdatingBook(Name,Address,PricePerDay,Available);
        }
    }

    private void startUpdatingBook(String name, String address, String pricePerDay, String available) {
        pd.setMessage("Updating Image");
        pd.setCancelable(false);
        pd.show();
        StorageReference mPictureRef = FirebaseStorage.getInstance().getReferenceFromUrl(products.getpImageUrl());
        mPictureRef.delete()
                        ...
                        ref.putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                if (uriTask.isSuccessful()) {
                                    ...
                                    hashMap.put("vendorNo", products.getVendorNo());

                                    ref.child(products.getpId()).updateChildren(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {

                                            pd.dismiss();
                                            Toast.makeText(VendorUpdateProductDetails.this, "Product Uploaded", Toast.LENGTH_SHORT).show();

                                            //reset view
                                            selected_img.setImageURI(null);
                                            image_rui = null;

                                            startActivity(new Intent(VendorUpdateProductDetails.this, VendorDashBoard.class));
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            ...
                                            Toast.makeText(VendorUpdateProductDetails.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                                            pd.dismiss();
    ...
    private void showImageDialog() {
        ...
        //dialog box
        AlertDialog.Builder builder=new AlertDialog.Builder(VendorUpdateProductDetails.this);
